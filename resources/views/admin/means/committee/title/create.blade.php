...
@section('title', 'Crear el Título de la Sección: Comité de Emergencia')
...
<li class="breadcrumb-item">
    <a href="{{ url('/administrador/titulos-comite-emergencia/create') }}">
...
<form action="{{ route('admin.titulos-comite-emergencia.store') }}" method="POST" enctype="multipart/form-data" >
@csrf
