...
@section('title', 'Editar Título de la Sección: Talento Humano')
...
<li class="breadcrumb-item">
    <a href="{{ url('/administrador/titulos-talento-humano/'. $talents->id.'/edit')  }}">
...
@section('content')
<form action="{{ route('admin.titulos-talento-humano.update', $talents->id) }}" method="POST" enctype="multipart/form-data" >
@csrf
@method('PUT')
        ...
        <div class="row">
          <div class="col-md-12"> 
            <div class="row">
             <div class="col-sm-6">              
              ...
              <input type="text" name="title" class="form-control" id="title" placeholder="Título..." value="{{  $talents->title }}">
              @if ($errors->has('title'))
          ...
          <div class="col-sm-6">
            ...
            <select name="means_id" id="means_id" class="form-control " style="width: 100%;">
              ...
              @foreach( $meanstitles as  $meanstitle)
                <option value="{{  $meanstitle->id }}" 
                  {{ $meanstitle->id == $talents->means_id ?'selected' : '' }}>
            ...
            <div class="form-group">
              ...
              <textarea name="content" id="content">{{ $talents->content }}</textarea>
                  ...
                  <div class="row">
                    <div class="row" id="gallery" data-toggle="modal" data-target="#exampleModal">
                      <div class="col-12 col-sm-6 col-lg-3">
                        <img  src="{{ asset('/storage/images/imagMeans/').'/'. $talents->image}}" alt="imagen" data-target="#carouselExample" data-slide-to="0" width="200px" height="200px">
                      </div>
                    </div>
                    <!-- Modal -->
                            ...
                            <div id="carouselExample" class="carousel slide" data-ride="carousel">
                              <div class="carousel-inner">
                                <div class="carousel-item active">
                                  <img class="d-block" src="{{ asset('/storage/images/imagMeans/').'/'.$talents->image}}" alt="imagen" width="465px" height="418px">
                                </div>
                              </div>
                            </div>
                          </div>
