...
<form action="{{ route('admin.subtitulos-amenazas.update',$threatsubtitles->id) }}" method="POST" enctype="multipart/form-data" >
     @csrf
     @method('PUT')
                    ...
                    <div class="row">
                      <div class="col-md-12">               
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="title" placeholder="Título..." value="{{$threatsubtitles->title }}">
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="content" id="content">{{  $threatsubtitles->content }}</textarea>
                         ...
                         <!-- /.BOTONES --> 
                        <div class="form-group">
                          <a class="btn btn-danger" href="{{ route('cancelar2','admin.subtitulos-amenazas.index') }}">Cancelar</a>
                          <input    
