...
@section('title', 'Crear Título de la Sección: Plan de Evacuación')
...
<li class="breadcrumb-item">
    <a href="{{ url('/administrador/titulos-plan-evacuacion/create') }}">
...
@section('content')
<form action="{{ route('admin.titulos-plan-evacuacion.store') }}" method="POST" enctype="multipart/form-data" >
@csrf
