...
<li class="breadcrumb-item">
    <a href="{{ url('/administrador/titulos-bloques/'. $blocktitles->id.'/edit') }}">
...
@section('content')
<form action="{{ route('admin.titulos-bloques.update',  $blocktitles->id) }}" method="POST" enctype="multipart/form-data" >
     @csrf
     @method('PUT')
