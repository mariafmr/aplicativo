...
@section('title', 'Crear Título de la Sección: Fases de Evacuación')
...
<li class="breadcrumb-item">
    <a href="{{ url('/administrador/titulos-fases-evacuacion/create') }}">
...
<form action="{{ route('admin.titulos-fases-evacuacion.store') }}" method="POST" enctype="multipart/form-data" >
@csrf
