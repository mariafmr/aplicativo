...
@section('title', 'Crear Evento Nuevo')
...
<li class="breadcrumb-item">
    <a href="{{ url('/administrador/eventos-nuevos/create') }}">
...
@section('content')
<form action="{{ route('admin.eventos-nuevos.store') }}" method="POST" enctype="multipart/form-data" >
  @csrf
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">  
              <div class="row">
                ...
                <div class="col-sm-3">
                  ...
                  <select name="event_id" id="event_id" class="form-control " style="width: 100%;">
                  ...
                  <span class="form-text text-danger">{{ $errors->first('event_id') }}</span>
                  @endif
                </div>
              </div>
              <div class="row">
            ...
            <!-- /.BOTONES --> 
            <div class="form-group">
              <a class="btn btn-danger" href="{{ route('cancelar1', 'admin.eventos-nuevos.index') }}">Cancelar</a>
