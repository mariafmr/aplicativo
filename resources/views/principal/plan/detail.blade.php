...
<li class="breadcrumb-item">   
   <a class="banner" href="{{ url('/plan-emergencias-unimar/fases-evacuacion' ) }}">{{ $phases['phase'] }}</a>
</li>
{{--<li class="breadcrumb-item">
   <a  class="banner" href="{{ url('/plan-emergencias-unimar/fases-evacuacion/'.$phases->id) }}">{{  $phases['phase'] }}</a>
</li>--}} 
@endsection
@endsection
@section('image')

<img alt="no-existe" src="{{ asset('/storage/images/imagPlan/'.$phases->evacuationtitle['image']) }}" 
          ...
          <div class="col-md-8">
             <div class="news_item shadow">
                <div class="image hover-effect img-container img-ta page-header parallaxie center-block">
                    <img alt="no-existe" src="{{ asset('/storage/images/imagPlan/'.$phases['image']) }}" class="img-responsive" width="10px">
                </div>
                <div class="news_desc text-left">
                  <h3 class="text-capitalize font-light darkcolor center bottom20">{{ $phases['phase'] }}</a></h3>
                  <p class="heading_space">{!! $phases['content'] !!}</p>
               </div>
             </div>
          </div>
          <div class="col-md-4">
