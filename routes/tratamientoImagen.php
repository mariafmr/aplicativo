...
//saber si extiste una imagen tener encuenta images--tiene la 
//relacion de muchos a muchos
 $threatstitles = App\ThreatsTitle::find(1);
 $image= $threatstitles->images;
...
//crear una imagen para un titulo utilizando el metodo save
//tener encuenta que images() hace referencia a la relacion**
$imagen = new App\Image(['url'=> 'imagenes/avatar.png']);

        $threatstitles = App\ThreatsTitle::find(1);

        $threatstitles->images()->save($imagen);

    return  $threatstitles;


//obtener las informaciones de las imagenes
// a traves del titulo
$threatstitles = App\ThreatsTitle::find(1);
return  $threatstitles->images->url;


//crear varias imagenes para un titulo
// utilizando el metodo savemany

$threatstitles = App\ThreatsTitle::find(3);

/*$threatstitles->images()->saveMany([
...
return $threatstitles->images;// comentar lo anterior para ver
//todas las iamgenes creadas
